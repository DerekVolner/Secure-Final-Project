...
#subtracted from it's index value in the read list"""
...
def encrypt2(plaintext, encrypted):
    try:
        ...
        #closes both output and input files and returns a print statement of the str and
        # the value the user inputted for users_file_encryption at the start 
        base_file.close()
